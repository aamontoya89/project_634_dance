	...
	var tempKinectronCanvas, tempKinectronContext;
	var container;
	...
	function init() {
	    ...
	    tempKinectronCanvas = document.getElementById('tempKinectronCanvas');
	    tempKinectronContext = tempKinectronCanvas.getContext('2d');
